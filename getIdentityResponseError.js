...
function getIdentityResponseError() {
      ...
      <SOAP-ENV:Body wsu:Id="body">
        <ns2:getIdentityResponse xmlns:ns2="http://egisz.rosminzdrav.ru">
          <ns2:IdentityResultResponse>
            ...
            <ns2:errors>
              <ns2:item>
                <ns2:code>NO_REQUEST_FOR_MESSAGE_ID</ns2:code>
                <ns2:message>Не найден запрос по данному идентификатору</ns2:message>
              </ns2:item>
            </ns2:errors>
          </ns2:IdentityResultResponse>
...
module.exports = getIdentityResponseError;
